...
update_status ModuleRenderExercise::Update()
{
	...
	glUniformMatrix4fv(glGetUniformLocation(programText, "view"), 1, GL_TRUE, &App->camera->mainCamera->LookAt(App->camera->mainCamera->position + App->camera->mainCamera->front)[0][0]);
